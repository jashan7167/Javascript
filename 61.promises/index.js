...
//.then takes the return value of the previous promise and passes it to the next promise
//.catch is used to catch any errors that may occur in the promise chain